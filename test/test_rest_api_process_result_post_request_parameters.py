...
class TestRestApiProcessResultPostRequestParameters(unittest.TestCase):
    """RestApiProcessResultPostRequestParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestApiProcessResultPostRequestParameters:
        """Test RestApiProcessResultPostRequestParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestApiProcessResultPostRequestParameters`
        """
        model = RestApiProcessResultPostRequestParameters()
        if include_optional:
            return RestApiProcessResultPostRequestParameters(
    ...
    def testRestApiProcessResultPostRequestParameters(self):
        """Test RestApiProcessResultPostRequestParameters"""
